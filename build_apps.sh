...
build_one "$ROOT_DIR/Gas_Detector_Lookup_Portable_CLPXfinal.html" "$OUT_DIR/gas-detector-app" "氣體偵測器"
build_one "$ROOT_DIR/氣體洩漏應變.html" "$OUT_DIR/gas-leak-response-app" "氣體洩漏應變"
